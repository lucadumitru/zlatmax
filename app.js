    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            selectBuild(originalSelect) {
                ...
                console.log(originalSelect.classList.value);
                originalSelect.classList.value ? selectItem.classList.add(`select_${originalSelect.classList.value}`) : null;
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                let fromValue = rangeItem.querySelector("[data-range-from]");
                let toValue = rangeItem.querySelector("[data-range-to]");
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (handle) toValue.value = Math.round(value); else fromValue.value = Math.round(value);
                }));
                ...
                mergeTooltips(item, 20, " - ");
                function mergeTooltips(slider, threshold, separator) {
                    var textIsRtl = "rtl" === getComputedStyle(slider).direction;
                    var isRtl = "rtl" === slider.noUiSlider.options.direction;
                    var isVertical = "vertical" === slider.noUiSlider.options.orientation;
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        allSlides.innerHTML = swiper.slides.length - 2;
                    },
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("There no are submenu");
                e.preventDefault();
            }
        ...
        window.addEventListener("click", (function(e) {
            if (document.querySelector(".catalog-header__menu").contains(e.target)) console.log("You clicked inside"); else {
                console.log("You clicked outside");
                const activeLink = document.querySelector("._sub-menu-active");
                const activeBlock = document.querySelector("._sub-menu-open");
                activeBlock.classList.toggle("_sub-menu-open");
                activeLink.classList.remove("_sub-menu-active");
            }
        }));
        window["FLS"] = true;
